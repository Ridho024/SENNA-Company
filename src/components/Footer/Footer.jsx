        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/tech-stack" className="text-gray-300 hover:text-white transition-colors">Tech Stack</Link></li>
              <li><Link to="/services" className="text-gray-300 hover:text-white transition-colors">Services</Link></li>
              <li><Link to="/portofolio" className="text-gray-300 hover:text-white transition-colors">Portfolio</Link></li>
